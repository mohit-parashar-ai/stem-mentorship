        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/foi_classes?utm_source=qr&igsh=YzU1NGVlODEzOA%3D%3D"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100092598306966&mibextid=ZbWKwL"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://www.linkedin.com/company/foi-classes/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://youtube.com/@foiclasses3468?si=QrD2ug32vrf92hIN"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
                aria-label="YouTube"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="pt-4">
                <Link
                  to="/contact"
                  className="btn btn-accent text-sm inline-block"
                >
                  Get in Touch
                </Link>
              </li>
